...
import { Variants, MotionProps, Variant } from 'framer-motion';
import { useState, useEffect, useCallback } from 'react';

// Bổ sung interface cho transition
interface VariantWithTransition extends Variant {
  transition?: {
    duration?: number;
    ease?: any;
    delay?: number;
  ...
  const containerProps: MotionProps = useMotionPreset(
    {
      ...
      animate: {
        ...
        transition: {
          ...listContainerVariants.animate.transition,
