...
import { backdropVariants, dialogVariants, useReducedMotion } from "@/lib/motion"
...
// Enhanced content with framer-motion
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      <DialogOverlay data-state={(props as any)["data-state"]} />
      <AnimatePresence>
        {isOpen && (
